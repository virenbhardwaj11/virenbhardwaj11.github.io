...
class MarvelMoviestabletWidget extends StatelessWidget {
  final String title;
  final String collection;
  final VoidCallback? onPressed;
  const MarvelMoviestabletWidget({
    required this.title,
    required this.collection,
    required this.onPressed
  });
...
class MarvelMovieswebWidget extends StatelessWidget {
  final String title;
  final String collection;
  final VoidCallback? onPressed;
  const MarvelMovieswebWidget({
    required this.title,
    required this.collection,
    required this.onPressed
  });
                            ...
                            children: [
                              ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: document['mimage'],
                                  progressIndicatorBuilder: (context, url, downloadProgress) =>
                                      Image.asset(fit: BoxFit.cover,"assets/loaderImg.gif", height: height * 0.3, width: width),
                                  errorWidget: (context, url, error) => const Icon(Icons.error),
                                ),
                              ),
                              Text(
                                document['mname'],
                                style: GoogleFonts.poppins(color: Colors.white,fontSize: width*.015),
                              )
                            ],
                          ),
                        ),
